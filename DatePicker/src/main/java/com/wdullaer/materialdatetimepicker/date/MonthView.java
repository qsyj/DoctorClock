...
public abstract class MonthView extends View {
    ...
    protected static final int MODE_NOT_SHOW_TITLE = 1;
    protected static final int MODE_SHOW_DAY = 2;
    ...
    /**
     * 0-->title labels num都显示  1-->不显示title 2-->不显示title labels
     */
    private int showMode = MODE_NOR;
    ...
    public boolean isShowTitle() {
        return showMode == MODE_NOR;
    }

    public boolean isShowLabels() {
        return showMode != MODE_SHOW_DAY;
    }
    ...
    public void setShowMode(int showMode) {
        switch (showMode) {
            case MODE_NOR:
                MONTH_HEADER_SIZE = getResources().getDimensionPixelOffset(R.dimen.mdtp_month_list_item_header_height);
                break;

            case MODE_NOT_SHOW_TITLE:
                MONTH_HEADER_SIZE = getResources().getDimensionPixelOffset(R.dimen.mdtp_month_list_item_not_title_header_height);
                break;
